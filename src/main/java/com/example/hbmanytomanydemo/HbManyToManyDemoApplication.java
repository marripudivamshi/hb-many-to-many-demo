package com.example.hbmanytomanydemo;
...
import com.example.hbmanytomanydemo.dao.InstructorDAO;
import com.example.hbmanytomanydemo.entity.Course;
import com.example.hbmanytomanydemo.entity.Instructor;
import com.example.hbmanytomanydemo.entity.InstructorDetail;
import com.example.hbmanytomanydemo.entity.Review;
import com.example.hbmanytomanydemo.entity.Student;

@SpringBootApplication
public class HbManyToManyDemoApplication {

	public static void main(String[] args) {
		SpringApplication.run(HbManyToManyDemoApplication.class, args);
	}
	...
	public CommandLineRunner commandLineRunner(InstructorDAO instructorDAO) {
		return runner -> {
			...
			//findStudentsAndCourses(instructorDAO);
			
			//addCoursesToStudent(instructorDAO);
